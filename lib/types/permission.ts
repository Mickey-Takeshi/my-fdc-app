...
export const DEFAULT_ROLE_PERMISSIONS: Record<Role, PermissionKey[]> = {
  ...
  admin: [
    'crm:read', 'crm:write', 'crm:dashboard', 'crm:export',
    'forms:read', 'forms:create', 'forms:edit', 'forms:view_responses', 'forms:export',
    'billing:read', 'billing:confirm_match',
    'members:read', 'members:invite', 'members:remove', 'members:change_role',
    'workspace:settings', 'workspace:audit_log',
  ],
  member: [
    'crm:read', 'crm:write', 'crm:dashboard',
    'forms:read',
    'members:read',
  ],
