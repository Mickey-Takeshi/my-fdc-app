/**
 * app/_components/leads/KanbanColumn.tsx
 *
 * Phase 6: カンバンカラムコンポーネント
 */
...
export function KanbanColumn({
  ...
  return (
    <div className="card">
      ...
      >
        <Circle size={20} fill={iconColor} stroke={iconColor} />
        {label}
        <span
          style={{
            fontSize: '14px',
              ...
              >
                <select
                  ...
                  onChange={(e) =>
                    onStatusChange(
                      lead,
                      e.target.value as LeadStatus | 'DELETE'
                    )
                  }
                  style={{
                    width: '100%',
